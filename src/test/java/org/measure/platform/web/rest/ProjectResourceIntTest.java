...
import org.measure.platform.restapi.app.entitys.ProjectResource;
...
public class ProjectResourceIntTest {
    ...
    private static final String DEFAULT_PROJECT_IMAGE = "AAAAA";
    private static final String UPDATED_PROJECT_IMAGE = "BBBBB";
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].projectImage").value(hasItem(DEFAULT_PROJECT_IMAGE.toString())));
    }
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.projectImage").value(DEFAULT_PROJECT_IMAGE.toString()));
    }
